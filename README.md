...
| Task | Supervision Type | Label Format |
|---|---|---|
| 🐠 **Classification** | Class labels | Category IDs |
| 🎭 **Segmentation** | Pixel-wise masks | Masked label images |
| 📍 **Regression** | Spatial coordinates | (x, y) coordinate labels |
